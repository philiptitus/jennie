...
import { updatePreparationBlock, resetPreparationBlockUpdate, updateCodingQuestion, resetCodingQuestionUpdate } from 'server/actions/actions1'; // Update the path accordingly
