import { Box, Button, Flex, IconButton, Input, Td, Text, Tr, useColorModeValue, useToast } from '@chakra-ui/react';
import { ViewIcon } from '@chakra-ui/icons';
import React, { useCallback } from 'react';
import { flexRender } from '@tanstack/react-table';

interface ComplexTableRowProps {
...
const ComplexTableRow: React.FC<ComplexTableRowProps> = ({
  row,
  showAnswer,
  setShowAnswer,
  answers,
